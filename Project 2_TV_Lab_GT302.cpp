...
void drawTV() {
    ...
    // Draw back face of TV
    glBegin(GL_QUADS);
    glVertex3f(-5.0f, -3.0f, -0.5f);  // Draw slightly behind to create thickness
...
void idle() {
    // Animasi putar-putar
    rotateY += 0.05f;  // Mengurangi kecepatan rotasi
    glutPostRedisplay(); // Redraw the scene
}
